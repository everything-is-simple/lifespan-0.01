...
当前 `37` 施工期间，历史硬超长 backlog 已降为 `4` 项，目标超长 backlog 仍为 `5` 项；每解决一项都必须同步回填 card / evidence / record / conclusion，并从 backlog 台账移除。
