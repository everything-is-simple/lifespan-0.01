...
from mlq.alpha.bootstrap_columns import (
    ALPHA_FORMAL_SIGNAL_EVENT_REQUIRED_COLUMNS,
    ALPHA_FORMAL_SIGNAL_RUN_EVENT_REQUIRED_COLUMNS,
)
...
ALPHA_LEDGER_DDL: Final[dict[str, str]] = {
    ...
    ALPHA_FORMAL_SIGNAL_EVENT_TABLE: """
        CREATE TABLE IF NOT EXISTS alpha_formal_signal_event (
            ...
            admission_verdict_code TEXT NOT NULL,
            admission_verdict_owner TEXT NOT NULL,
...
ALPHA_FORMAL_SIGNAL_REQUIRED_COLUMNS: Final[dict[str, dict[str, str]]] = {
    ...
    ALPHA_FORMAL_SIGNAL_EVENT_TABLE: ALPHA_FORMAL_SIGNAL_EVENT_REQUIRED_COLUMNS,
    ALPHA_FORMAL_SIGNAL_RUN_EVENT_TABLE: ALPHA_FORMAL_SIGNAL_RUN_EVENT_REQUIRED_COLUMNS,
}
