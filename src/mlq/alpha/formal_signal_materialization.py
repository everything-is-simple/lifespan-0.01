...
def _upsert_formal_signal_event(
    ...
    *,
    ...
    existing_fingerprint = (
        ...
        _normalize_optional_float(existing_row[28]),
        _normalize_optional_float(existing_row[29]),
        _normalize_optional_float(existing_row[30]),
        _normalize_optional_nullable_str(existing_row[31]),
        _normalize_optional_str(existing_row[32]),
        _normalize_optional_str(existing_row[33]),
        _normalize_optional_str(existing_row[34]),
        _normalize_optional_str(existing_row[35]),
    )
    new_fingerprint = (
        event_row.formal_signal_status,
        event_row.trigger_admissible,
