...
4. 先看最新已生效结论 `25-malf-mechanism-ledger-bootstrap-and-downstream-sidecar-integration-conclusion-20260411.md`
...
8. 当前治理锚点是 `25-malf-mechanism-ledger-bootstrap-and-downstream-sidecar-integration-card-20260411.md`
...
3. 当前最新封存口径是：`malf` 的正式核心已收缩为按时间级别独立运行的纯语义走势账本，bridge-era `pivot-confirmed break / same-timeframe stats sidecar` 也已经正式落成账本、runner、checkpoint 与最小 `structure / filter` 接入；这仍不代表 pure semantic canonical runner 已完成。
