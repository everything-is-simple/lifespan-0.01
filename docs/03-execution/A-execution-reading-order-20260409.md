...
5. 如果要复盘当前已收口主线卡，回看 `17-raw-base-strong-checkpoint-and-dirty-materialization-card-20260410.md`
6. 如果要继续正式施工，打开当前方案选型卡 `18-daily-raw-base-fq-incremental-update-source-selection-card-20260410.md`
...
4. 当前待施工卡已切到 `18`，但这张卡只做 `raw/base` 第二阶段每日复权增量更新方案选型；在新结论生效前，正式入口仍保持卡 `17` 口径。
