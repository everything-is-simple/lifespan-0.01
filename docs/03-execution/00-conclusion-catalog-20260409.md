...
当前最新生效结论锚点：`91-malf-timeframe-native-base-source-rebind-conclusion-20260418.md`
...
72. `72-historical-objective-profile-backfill-execution-conclusion-20260415.md`
73. `73-market-base-backward-full-history-backfill-conclusion-20260416.md`
74. `74-market-base-batched-bootstrap-governance-conclusion-20260416.md`
...
111. `80-malf-zero-one-wave-filter-boundary-freeze-conclusion-20260418.md`
112. `82-malf-break-invalidation-confirmation-contract-freeze-conclusion-20260419.md`
113. `83-malf-last-valid-structure-anchor-and-stale-guard-governance-conclusion-20260419.md`
114. `84-malf-canonical-materialization-repair-and-three-ledger-rebuild-conclusion-20260419.md`
115. `85-malf-post-rebuild-truthfulness-and-audit-acceptance-gate-conclusion-20260419.md`
116. `91-malf-timeframe-native-base-source-rebind-conclusion-20260418.md`
117. `92-structure-thin-projection-and-day-binding-conclusion-20260418.md`
118. `93-filter-objective-gate-and-note-sidecar-demotion-conclusion-20260418.md`
119. `94-alpha-dual-axis-decision-rebind-and-formal-cutover-conclusion-20260418.md`
120. `95-malf-alpha-official-truthfulness-and-cutover-gate-conclusion-20260418.md`
## 主线状态
1. `91` 已成为当前最新生效结论锚点。
...
flowchart LR
    ...
    subgraph NEXT["60-66 / 79-85 / 91-95 / 100-105"]
        C100["60-66 -> 79-85 -> 91-95 -> 100-105"]
    end
