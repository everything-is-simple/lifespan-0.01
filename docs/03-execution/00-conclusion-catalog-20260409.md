...
当前最新生效结论锚点：`35-downstream-data-grade-checkpoint-alignment-after-malf-conclusion-20260412.md`
...
1. `35` 已成为当前最新生效结论锚点。
2. `28` 仍是当前未收口的总治理主卡，当前待施工卡已推进到 `36`。
3. `29-35` 已完成并生效，当前 malf 后续 sidecar 卡为 `36`。
4. `100-105` 为 `36` 收口后的 trade/system 后置恢复卡组，**不得在 36 完成前提前推进**。
